...
<div class="flex items-center space-x-2 rtl:space-x-reverse filament-tables-pagination-records-per-page-selector">
    <select wire:model="tableRecordsPerPage" id="tableRecordsPerPageSelect" class="{{ \Illuminate\Support\Arr::toCssClasses([
    ...
    <label for="tableRecordsPerPageSelect" class="{{ \Illuminate\Support\Arr::toCssClasses([
        'text-sm font-medium',
