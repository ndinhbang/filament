...
<tr x-cloak class="{{ \Illuminate\Support\Arr::toCssClasses(['bg-primary-500/10 filament-tables-selection-indicator']) }}">
    <td class="px-4 py-2 whitespace-nowrap text-sm" colspan="{{ $colspan }}">
        <div>
            ...
            <span class="{{ \Illuminate\Support\Arr::toCssClasses(['dark:text-white' => config('tables.dark_mode')]) }}" x-text="
