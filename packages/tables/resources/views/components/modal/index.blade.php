...
>
    ...
    >
        <button
            ...
            type="button"
            aria-hidden="true"
            class="fixed inset-0 w-full h-full bg-black/50 focus:outline-none filament-tables-modal-close-overlay"
        ></button>
        ...
        >
            <div
                {{ $attributes->class([
                    'w-full mx-auto p-2 space-y-2 bg-white rounded-xl cursor-default filament-tables-modal-window',
            ...
            >
                @if ($header)
                    <div class="px-4 py-2 filament-tables-modal-header">
                        {{ $header }}
                    </div>
                @endif
                ...
                <div class="space-y-2 filament-tables-modal-content">
                ...
                @if ($footer)
                    <div class="px-4 py-2 filament-tables-modal-footer">
                        {{ $footer }}
                    </div>
                @endif
            </div>
