...
<div class="{{ \Illuminate\Support\Arr::toCssClasses(['filament-page']) }}">
    <div class="space-y-6">
    ...
    <form wire:submit.prevent="callMountedAction">
        ...
        <x-filament::modal id="page-action" :width="$action ? $action->getModalWidth(): '4xl'" display-classes="block">
            @if ($action)
